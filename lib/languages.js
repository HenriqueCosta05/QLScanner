...
/**
 * Returns the display labels for all CodeQL-supported languages.
 * @returns {string[]}
 */
...
/**
 * Resolves a requested language (or alias) to a canonical CodeQL configuration.
 * Throws when the language is unsupported.
 * @param {string} requestedLanguage
 * @returns {{name: string, aliases: string[], extensions: string[], queryPack: string, querySuite: string, databaseLanguage: string, label: string}}
 */
...
/**
 * Infers the dominant CodeQL language from a list of file paths.
 * Returns null if no supported language extension is found.
...
/**
 * Infers the dominant CodeQL language from git-tracked files in a repository.
...
/**
 * Returns a regex that matches file paths ending in supported extensions.
 * @returns {RegExp}
 */
...
/**
 * Normalizes a requested language (or alias) to its canonical mapping key.
 * @param {string} value
 * @returns {string|null}
 */
